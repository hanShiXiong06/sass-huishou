<template>
	<u-tabbar :value="value" @change="tabbarChange" zIndex="9999" :fixed="true" :placeholder="false" :safeAreaInsetBottom="true"
	...
	<view class="tab-bar-placeholder" style='height: 0;'></view>
</template>
